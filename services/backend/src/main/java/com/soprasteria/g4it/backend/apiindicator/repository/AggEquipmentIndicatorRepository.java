...
public interface AggEquipmentIndicatorRepository extends JpaRepository<AggEquipmentIndicator, Long> {
    ...
    @Query(nativeQuery = true, value = """
            INSERT INTO agg_equipment_indicator (criteria, acv_step, entity, equipment, status, country, batch_name, impact, unit, sip, quantity)
            SELECT
            ...
            WHERE
               iep.statut_indicateur = 'OK'
               AND iep.nom_lot = :batchName
