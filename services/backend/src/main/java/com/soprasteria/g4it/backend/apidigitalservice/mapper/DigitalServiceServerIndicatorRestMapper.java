...
public interface DigitalServiceServerIndicatorRestMapper {

    DigitalServiceServerIndicatorRest toDto(final DigitalServiceServerIndicatorBO source);

    List<DigitalServiceServerIndicatorRest> toDto(final List<DigitalServiceServerIndicatorBO> source);
}
