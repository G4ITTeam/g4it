 ...
 */ 
package com.soprasteria.g4it.backend.apibatchloading.steps.physicalequipment.tasklet;
...
/**
 * Tasklet to delete all not linked physical equipments.
 */
@AllArgsConstructor
public class DeleteAfterConsistencyCheckTasklet implements Tasklet {
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) throws Exception {
        physicalEquipmentRepository.deleteAfterConsistencyControl(sessionDate);
