...
@Repository
public interface DigitalServiceNetworkIndicatorRepository extends JpaRepository<DigitalServiceNetworkIndicatorView, String> {

    List<DigitalServiceNetworkIndicatorView> findDigitalServiceNetworkIndicators(@Param(PARAM_ORGANIZATION) final String organization,
