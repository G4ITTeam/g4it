...
/**
 * Repository to calculate the physical equipment low carbon indicators view.
 */
@Repository
public interface PhysicalEquipmentLowCarbonViewRepository extends JpaRepository<PhysicalEquipmentLowCarbonView, Long> {
    ...
    List<PhysicalEquipmentLowCarbonView> findPhysicalEquipmentLowCarbonIndicators(@Param(PARAM_SUBSCRIBER) final String subscriber,
