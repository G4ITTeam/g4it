 ...
 */
@Repository
public interface DataCenterIndicatorViewRepository extends JpaRepository<DataCenterIndicatorView, Long> {
    ...
    List<DataCenterIndicatorView> findDataCenterIndicators(@Param(PARAM_INVENTORY_ID) final Long inventoryId);
