...
class EquipmentFiltersRepositoryTest {
    ...
    void shouldReturnListOfFilters() {
        final List<EquipmentFilters> filters = this.equipmentFiltersRepository.getFiltersByInventoryId(601L, "june-2022");
        assertAll(
                ...
                () -> assertThat(filters.get(1)).extracting(EquipmentFilters::getType).isEqualTo("SSG_Compute"),
