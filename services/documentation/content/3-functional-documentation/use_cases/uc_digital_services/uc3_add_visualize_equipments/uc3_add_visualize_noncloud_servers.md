...
| 10        |            | Create                       | button    | <li><u>*action rules*</u>: Create the non cloud servers from the current Digital Service.<br>Note : The user must click on Calculate to update the footprint estimation. |
